...
#' Match suffix of scanner
#'
#' This is part of the subject label, which is useful to differentiate between
#' scanners from the same site.
match_scanner_suffix <- function(site, sid) {
  if (site == "TJNU") {
    tjnu_scanner$suffix[tjnu_scanner$sid == sid]
  } else {
    ""
  }
}
